				...
				<!--Cover Image Needed add in common.css-->
					...
					<center>
						<div class="w3-content w3-display-container">
						  <img class="mySlides" src="fetchimage1.php?IMAGES_ID=1" style="height:740px;">
						  <img class="mySlides" src="fetchimage2.php?IMAGES_ID=2"style="height:740px;">
						  <img class="mySlides" src="fetchimage3.php?IMAGES_ID=3"style="height:740px;">
						  <img class="mySlides" src="fetchimage4.php?IMAGES_ID=4" style="height:740px;">

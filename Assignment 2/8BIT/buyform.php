	...
	<div id="cMain">
		...
		{ ?>
			...
			<div class="group_detail group_billing">
				...
				<form action="buy_verify.php" method="post" id="payment-form">
				...
				<div class="group_set" style="">
							<dl class="list_regist">
									...
									<div class="group_set">
										<div class="box_tf">
											<input  class="tf_comm" id="cardExp" name="cardExp" type="date" required> <span class="img_black ico_error"></span>
										</div>
										<span class="txt_error">Required</span>
									</div>

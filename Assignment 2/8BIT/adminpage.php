...
/* Notes 21600681
	check for duplicates still not working but it is there
*/
?>
		...
		<div id="cMain">
			<div id="mArticle">
				...
				<div class="detail_black">
					...
					<h3 id="coupon" class="tit_group">
					<span class="img_black ico_coupon"></span>SCREENSHOT MANAGEMENT</h3>
					<b style="color:Black">
					<br>
					Select image from uploads folder to send to database</b>
					<br><br>
					<b style = "color:black;font-size:15px;font-style:italic">Please note: These files will be displayed on the homepage</b>
					<br>
						...
						<input type="submit" value="Upload Image" name="submit" style="background-color:#4e8064;cursor: pointer;">
											...
											<br>
					<b style = "color:black;font-size:15px;font-style:italic">Change the images that display on home page</b>						
					<form action="updateimage.php" method="post" enctype="multipart/form-data">
					<input type="submit" value="Update Images in Database" name="submit" style="background-color:#4e8064;cursor: pointer;">
					</form>
					<!------------------------------->	
									...
									<table style="color:#111;" id="PRODUCT_TABLE">
									  ...
									  <?php
										...
										foreach ($dbrs as $dbrow) {
													...
													echo '<td width=250>';
													/*Error here?*/
													echo '<a  class="btn_regist" href="PRODUCT/update.php?id='.$dbrow['PRODUCT_ID'].'">Update</a>';
													echo ' ';
													echo '<a  class="btn_regist" href="PRODUCT/delete.php?id='.$dbrow['PRODUCT_ID'].'">Delete</a>';
													echo '</td>';
													echo '</tr>';
										}
